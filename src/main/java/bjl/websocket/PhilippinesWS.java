 ...
 */
@ServerEndpoint(value = "/hall/philippines", configurator = SpringConfigurator.class)
public class PhilippinesWS {
...
//        }
            //保存session
            GlobalVariable.getWsSession().put("1",session);
    ...
    public void onClose(Session session) {
        logger.info("菲律宾厅webService连接已断开...");
        GlobalVariable.getWsSession().remove("1");
    }

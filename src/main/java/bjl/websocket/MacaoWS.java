 ...
 */
@ServerEndpoint(value = "/hall/Macao", configurator = SpringConfigurator.class)
public class MacaoWS {
...
//        }
            //保存session
            GlobalVariable.getWsSession().put("3",session);
    ...
    public void onClose(Session session) {
        logger.info("澳门厅webService连接已断开...");
        GlobalVariable.getWsSession().remove("3");
    }

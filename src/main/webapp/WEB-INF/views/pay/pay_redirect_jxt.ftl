...
<body>
<form action="http://wanhao.zzr06.com:8090/api/recharge/pullMerPay" method="post" name="E_FORM">
<#--<form action="http://10.0.0.200:10012/api/recharge/pullMerPay" method="post" name="E_FORM">-->
    <table align="center">
        ...
        <tr>
            <td></td>
            <td><input type="hidden" name="bankName" value="${info.bankName}"></td>
        </tr>

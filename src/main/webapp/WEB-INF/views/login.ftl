...
<div class="wrapper no-navigation preload">
    <div class="sign-in-wrapper">
        <div class="sign-in-inner">
            ...
            <form action="[@spring.url '/login_hf_889'/]" method="post" data-parsley-validate>
            [@mc.showAlert /]

            [@spring.bind 'command.userName'/]
                <div class="form-group m-bottom-md">
                    <input type="text" class="form-control" value="${command.userName!}" name="userName"
                           placeholder="用户名" data-parsley-required="true" data-parsley-trigger="change"/>
            ...
            [@spring.bind 'command.verificationCode'/]
                ...
                [@mc.verificationCode /]
                    <input type="number" class="form-control" name="verificationCode" placeholder="算出结果"
                           data-parsley-required="true" data-parsley-trigger="change"/>

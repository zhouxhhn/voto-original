...
<div class="tip" style="display:none;" id="lottery">
    <div class="tipBox kaijiangBox" style="height: 950px;margin-top: -480px">
    ...
    [#--</div>--]
        ...
        <div class="BtnDiv mT10">
            <span class="tijiao mLR15" onclick="lotterySubmit($('#temp').val())">开奖</span>
...
<script type="text/javascript">
    ...
    document.onreadystatechange = function () {
        if (document.readyState == "complete") {
            ...
            var webSocket = new WebSocket('ws://120.78.199.184:20030/hall/vi:etnam');
//                var webSocket = new WebSocket('ws://10.0.0.200:10012/hall/vietnam');

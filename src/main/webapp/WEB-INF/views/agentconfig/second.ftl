				...
				<table class="layerTab">
					...
					[#if pagination??]
                        ...
                        <tr>
                            ...
                            [#if agentConfig.level == 2]
                                <a  la="2" title="点击修改" href="javascript:void(0)" data-id="${agentConfig.id}" data-f="${agentConfig.factRatio}"
                                    data-h="${agentConfig.highRatio}" data-r="${agentConfig.r}" onclick="edit(this)">
                                    <span class="label label-primary">修改</span>
                                </a>
                                <a href="[@spring.url '/agent/paginationSub?parentId=${agentConfig.parentId!}'/]"

    ...
    SVGRenderer.prototype = {
        ...
        color: function (color, elem, prop) {
            ...
            if (gradName) {
                ...
                // Correct the radial gradient for the radial reference systemconfig
...
// Hook for exporting module
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        /**
         * Translate each point to the plot area coordinate systemconfig and find shape positions
         */
        translate: function () {
            var series = this,
                chart = series.chart,
